...
export const profileData = {
  ...
  tagline: "Moving Forward with a goal to make impact in the world of Technology",
  education: "B.Tech in Information Technology | 3rd Year",
  university: "Madan Mohan Malviya University of Technology",
  year: "2023 - 2027",
  email: "parmarabhishek2404@gmail.com",
  github: "https://github.com/Abhishek024604",
  linkedin: "https://linkedin.com/in/abhishek-singh-316300284",
  bio: `Hi! I'm a third-year Computer Science student passionate about building scalable web applications and has passion for learning Artificial Intelligence. I love turning complex problems into elegant solutions through code. When I'm not debugging, you'll find me thinking about new product ideas or learning new technologies.`
};
...
export const projects = [
  ...
  },
  {
    ...
    description: "A modern portfolio website designed for a creative agency to showcase its services, projects, and brand identity. The site emphasizes clean visual hierarchy, smooth interactions, and responsive layouts to deliver a polished user experience.",
    tech: ["React", "JavaScript", "Tailwind CSS"],
    github: "https://github.com/Abhishek024604/WebsiteAgency",
    demo: "https://github.com/Abhishek024604/WebsiteAgency",
    category: "Frontend Development",
    status: "Completed"
  },
  {
    id: "proj-7",
    title: "BudgTrack - Budget Tracking Application for Personal Finance",
    description: "BudgTrack is a personal finance web application designed to help users track income, manage expenses, and monitor budgets with clarity and ease. The app provides an intuitive interface for organizing financial data, visualizing spending patterns, and maintaining better control over personal finances through structured insights and summaries.",
    tech: ["React", "JavaScript", "Tailwind CSS"],
    github: "https://github.com/Abhishek024604/BudgetTracker",
    demo: "https://github.com/Abhishek024604/BudgetTracker",
    category: "Frontend Development",
    status: "Completed"
  }
];
...
export const education = [
  {
    ...
    highlights: [
      ...
      "Member of Coding Club and Web Development Societies",
      "Participant in SIH 2024 Hackathon"
    ]
  },
  {
    id: "edu-2",
...
export const skills = {
  ...
  AI: ["OpenAI API", "LangChain", "OpenRouter", "LLMs", "RAG"],
  databases: ["MongoDB", "PostgreSQL", "MySQL", "Firebase", "Pinecone DB"],
  tools: ["Git", "VS Code", "Postman"],
  concepts: ["Data Structures", "Algorithms", "OOP", "DBMS", "System Design"]
};

export const achievements = [
  "🏆 Participated and qualified for regionals in Smart India Hackathon 2024",
  // "⭐ 500+ contributions on GitHub",
  "📜 Hands on experience in IoT and Cloud Technologies",
  "🎯 Solved 700+ programming problems across coding platforms like Leetcode, Codeforces, Codechef"
];
